import{l0 as be,np as we,qF as De,FB as f,qw as w,qC as Ve,qm as F,Jm as r,td as j,Hh as ee,CH as xe,qt as y,me as te,jo as A,k5 as B,qG as Le,D4 as ie,FH as ne,qr as S,g$ as _,BF as v,On as se,AW as ae,zL as o,Kv as re,hY as Ee,G as ye,fP as Se,pf as le,zZ as oe,LI as Ce,Js as Me,v6 as Ae,Jp as $e,qx as Re,Bc as H,pp as Te,oj as ce,IM as he,jP as de,mn as Oe,EH as G,LQ as q,jM as c,m4 as z,Ip as pe,gf as ue,pe as Ie,K8 as I,ju as Ue,FE as qe,EO as je,l1 as ze,vs as V,KB as Ne,hx as k,HG as We,ES as Fe,DU as $,CJ as Be,bh as J,y$ as He,LY as Ge,fx as ke,Dn as Je,lD as Ke,uS as Qe,jU as C,lR as Xe,IC as K}from"./index-BMEvFs-d.js";import{t as Ye}from"./VisualElement-BtBvkqLA.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
