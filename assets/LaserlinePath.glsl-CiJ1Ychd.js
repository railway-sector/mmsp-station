import{kE as Pe,mY as be,p_ as we,EV as f,pP as w,pV as Ve,pI as W,IB as r,FO as U,GB as Z,BI as De,pM as C,oI as ee,j3 as R,jL as B,p$ as xe,C7 as te,F0 as ie,pK as M,bs as m,AM as v,Nj as ne,zZ as se,yP as o,A_ as ae,hJ as Ee,vi as Le,fv as ye,lO as re,z4 as le,KP as Se,IJ as Ce,u2 as Me,IH as Ae,pQ as $e,Ab as H,oL as Re,rU as oe,IC as ce,jv as he,me as Te,E0 as G,KQ as j,js as c,lF as z,HJ as de,fY as pe,oz as Ie,Jn as I,j9 as Oe,EY as je,E8 as qe,kG as Ue,up as D,kF as ze,rX as k,F5 as Ne,Ec as Fe,D2 as T,BK as We,xR as Be,L1 as He,f6 as Ge,Ca as ke,l3 as Je,tr as Ke,jx as A,lt as Qe,H_ as J}from"./index-jrOYkiPV.js";import{t as Xe}from"./VisualElement-B9Yntdtc.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=U(6);function fe(t){const e=new Z;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
