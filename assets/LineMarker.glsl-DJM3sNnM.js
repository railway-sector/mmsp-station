import{GB as ee,rc as te,ur as ie,un as re,r8 as ae,pQ as se,pR as oe,IB as o,C$ as ne,IH as ce,F0 as le,Ab as _,LP as pe,pS as de,GY as I,sW as he,pG as ve,pH as ue,pM as me,pI as fe,us as N,oe as R,Af as ge,kB as Se,oa as Pe,fY as ye,rU as we,HJ as _e,IC as ze,jv as xe,LM as M,ID as U,mT as $e,r9 as B,Kq as L,rb as be,sX as Te,xl as ke,BE as Ve,BF as k,ra as De,pT as Oe,Ag as q,kC as H,Kt as We,ut as Ce,kD as Me,js as c,lF as Le,EW as Ae,up as d,jJ as Fe,kx as Ee,Mm as G,Bc as je,E_ as Ie,II as Ne,IE as Re,Jn as Y,bS as Ue,bs as J,yP as K,Mn as Be}from"./index-jrOYkiPV.js";function Q(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
